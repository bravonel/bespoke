            ...
            <div class="flex flex-col gap-4 border-b border-stone-200 p-6 sm:flex-row sm:items-start sm:justify-between">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 max-w-xl text-sm leading-6 text-slate-600">Deja tu trabajo operativo a otro colaborador durante una ausencia. La cobertura inicia y termina automáticamente.</p>
                    </div>
                </div>
    ...
    <x-modal name="create-coverage" :show="$errors->any() && old('_form') === 'coverage'" max-width="lg" focusable>
        <form method="POST" action="{{ route('coverages.store') }}">
            ...
            <div class="flex justify-end gap-3 border-t border-stone-200 bg-stone-50 px-6 py-4">
                ...
                <button type="submit" class="button-primary">Programar cobertura</button>
            </div>
        </form>
    </x-modal>
